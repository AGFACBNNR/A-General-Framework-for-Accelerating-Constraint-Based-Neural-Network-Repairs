...
class Experiment:
    ...
    def __init__(self, args):
        ...
        self.size = args.size
        self.directory = "results/PRDNN_mem/{}_{}_{}".format(args.directory,args.layer,args.size)
        self.networkPath = f"../networks/{self.dir}_{args.attack}.onnx"
    ...
    def load_network(network_name,maxify_acas):
        ...
        if "squeezenet" in network_name:
            return Network.from_file("squeezenet1.1.onnx")
    ...
    def main(self):
        ...
        #json.dump({'mem':peak/(1024**3)},open(f"{self.directory}_mem.json","w"),indent=6)
